...
const VolumeIcon = () => {
  ...
  return (
    <>
      {value <= 1 && value > 0.5 && <BsFillVolumeUpFill size={25} className="cursor-pointer" color="#FFF" onClick={() => setVolume(0)} />}
      {value <= 0.5 && value > 0 && <BsVolumeDownFill size={25} className="cursor-pointer" color="#FFF" onClick={() => setVolume(0)} />}
      {value <= 0 && <BsFillVolumeMuteFill size={25} className="cursor-pointer" color="#FFF" onClick={() => setVolume(1)} />}
    </>
  )
}
